        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                foreach (var arg in args)
                {
                    ...
                    {
                        langArg = arg.Substring(6);
                    }
                }

                if (!string.IsNullOrEmpty(langArg))
                {
                    API.LanguageManager.CurrentLanguage = langArg;
                }
                ...
                using (API.Client client = new())
                {
                    ...
                    if (isIdleMode)
                    {
                        ...
                        var idleTimer = new System.Windows.Threading.DispatcherTimer
                        {
                    ...
                    app.Run(new ManagerWindow(appId, client, langArg));
                }
            }
            catch (Exception ex)
            {
